...
interactivity that the system demands, we evaluate different array based
storage systems and compare the tradeoffs of each against a simple storage
...
The on disk representation is kept simple. The first byte of the file contains
...
Integrating HDF5 as a \c{StorageBackend} is straightforward. Using the
