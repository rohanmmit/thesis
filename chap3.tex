...
at a client's request and transferring data back for rendering. In addition,
...
easily modify existing or add new processing algorithms.
...
amount of padding for performance reasons. This is the same binary
representation as the \c{BinaryBackend} uses. See
...
performance is not an issue, Python is a viable option. \\
