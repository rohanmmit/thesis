...
\cite{dropbox-json} \cite{websocket-server} \cite{tiledb} in each layer (in
addition to many other larger community libraries) and without these, the
...
and work with the developers to make the projects better by submitting patches
and helping them pinpoint bugs. \\
